...
Interpolation results for \SI{0}{\kelvin} \gls{ms} low-noise Ni simulations are shown as a hexagonally binned parity plot in \cref{} and can be visually compared with Figure 6(a) of \citet{chesserLearningGrainBoundary2020}.

\begin{figure}
    \centering
    \includegraphics{}
    \caption{Hexagonally binned parity plot for Ni simulation \acrfull{gbe} interpolation.}
    \label{fig:my_label}
\end{figure}
