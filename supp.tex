...
% a latexmkrc file also needs to be added, see overleaf link
...
\begin{figure}
     ...
     \end{subfigure}
        \caption{(left) Hexagonally binned parity plot for Ni simulation \acrfull{gbe} interpolation using \acrshort{loocv}. (right) Parity plot for \acrfull{loocv} interpolation results reproduced from Figure 6a of \citet{chesserLearningGrainBoundary2020} under CC-BY Creative Commons license. }
