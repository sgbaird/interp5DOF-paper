...
Built-in MATLAB functions are indicated with parantheses (e.g. \matlab{delaunayn()}), whereas custom functions are indicated with the \matlab{.m} extension (e.g. \matlab{sphconvhulln.m}).
%
...
\begin{itemize}%[nolistsep]
	...
	\outpt{} points
	\item[2.1b] using the \matlab{interp5DOF.m} sub-routine \matlab{proj\_down.m} (via \matlab{svd()}) to perform the transformation
