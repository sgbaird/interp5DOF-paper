...
\begin{figure}
    ...
    \caption{Hexagonally binned parity plots of the Euclidean distance approximation converted to octonions compared with the traditional octonion metric, where the minimum distance among an ensemble of \gls{vfzo} sets is used for 1 (a), 2 (b), 5 (c), and 10 (d) \gls{vfzo} sets. As the number of \gls{vfzo} sets increases, the correlation between the Euclidean distance and the traditional octonion distance improves.}
