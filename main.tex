...
%RMSE values
\newcommand{\baryrmse}{0.6}
\newcommand{\gprrmse}{0.5}
\newcommand{\idwrmse}{0.7}
\newcommand{\nnrmse}{0.8}
\newcommand{\avgrmse}{0.13}

%MAE values
\newcommand{\barymae}{0.5}
\newcommand{\gprmae}{0.4}
\newcommand{\idwmae}{0.6}
\newcommand{\nnmae}{0.7}
\newcommand{\avgmae}{0.097}
...
\caption{Histogram of \gls{nn} octonion distances ($\omega$) in a \gls{vfzo} set of \num{50000} points. The average \gls{nn} distance was \SI{2.87 \pm 0.7}{\degree}. the average k-th nearest neighbor distances demonstrate many nearest neighbors fall within a tight tolerance (less then \SI{10}{\degree}) out of approximately 10 trial runs (b).}
