...
\begin{figure}
    \centering
    \includegraphics{baryproj.png}
    \caption{3D to 2D analogue of 7D Cartesian to 6D Cartesian mesh triangulation used in barycentric interpolation approach. Starting points on surface of 2-sphere (a), points projected onto hyperplane tangent to mean of input points (b), degenerate dimension removed via \acrfull{svd} projection to 2D Cartesian where triangulation is computed (c).}
    \label{fig:baryproj}
\end{figure}
