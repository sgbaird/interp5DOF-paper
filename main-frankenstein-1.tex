...
In this work, we presented the \gls{vfz} framework for (i) computing distances between \glspl{gb} and (ii) predicting the properties of \glspl{gb} from existing measurements. We found that distance calculations in the \gls{vfz} framework are dramatically more computationally efficient %($O(N_p^2L)$)
